...
// class ReservationDetailList extends StatelessWidget {
//   const ReservationDetailList({
//     Key? key,
//     required this.reserveDetailList,
//   }) : super(key: key);
...
//       itemCount: reserveDetailList.length,
//       itemBuilder: (context, index) {
//         final item = reserveDetailList[index];
//         return GestureDetector(
//           onTap: () {
//             // Add your logic here for the action to be performed on tap.
//             // print('Tapped on item ${item.equipmentItemId}');
//             NavigationScreen.navigate(
//                 context,
//                 ReservationDetailsScreen(
//                   Item: item,
