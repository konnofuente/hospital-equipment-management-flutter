...
class ChatGroupListUI extends StatefulWidget {
  @override
  _ChatGroupListUIState createState() => _ChatGroupListUIState();
}

class _ChatGroupListUIState extends State<ChatGroupListUI> {
  @override
